...
class AtelierTypography {
  ...
  // ── Serif (Fraunces italic — month name on home, brand wordmark) ──
  // The detail screen header (pocket name) used to live here too; it now
  // uses Inter (sansLabel-derived) to match the goal-text family.
  ...
  // ── Sans (Inter — body copy, settings labels, detail header) ──
